<flux:modal name="create-product" class="md:w-[800px] !p-0 overflow-hidden bg-white dark:bg-zinc-900 rounded-xl">
    <div
        ...
        <div>
            <h3 class="text-lg font-semibold leading-6 text-zinc-900 dark:text-white">Nuevo Producto</h3>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Complete la información para registrar un nuevo
                producto.</p>
        </div>
    </div>
    ...
    <div class="px-6 py-6 max-h-[calc(100vh-200px)] overflow-y-auto">
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Bar Code -->
                <div>
                    <label for="bar_code" class="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-200">
                    ...
                    <div class="mt-2 relative rounded-md shadow-sm">
                        ...
                        <input type="text" wire:model="bar_code" id="bar_code"
                            class="block w-full rounded-lg border-0 py-2.5 pl-10 text-zinc-900 ring-1 ring-inset ring-zinc-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-zinc-800/50 dark:text-white dark:ring-zinc-700 dark:placeholder-zinc-500 dark:focus:ring-indigo-500"
                ...
                <div>
                    ...
                    <div class="mt-2 relative rounded-md shadow-sm">
                        ...
                        <input type="number" step="0.01" wire:model.live="cost_price" id="cost_price"
                ...
                <div>
                    ...
                    <div class="mt-2 relative rounded-md shadow-sm">
                        <input type="number" step="1" min="0" wire:model="initial_stock" id="initial_stock"
                            class="block w-full rounded-lg border-0 py-2.5 px-3 text-zinc-900 ring-1 ring-inset ring-zinc-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-zinc-800/50 dark:text-white dark:ring-zinc-700 dark:placeholder-zinc-500 dark:focus:ring-indigo-500"
                            placeholder="0">
                    </div>
                    @error('initial_stock') <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>

                <!-- Status -->
                <div>
                    <label for="status" class="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-200">
                        Estado
                    </label>
                    <div class="mt-2">
            ...
            <!-- Description -->
            <div>
                <label for="description" class="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-200">
