<flux:modal name="create-category" class="md:w-[500px] !p-0 overflow-hidden bg-white dark:bg-zinc-900 rounded-xl">
    <div
        ...
        <div>
            <h3 class="text-lg font-semibold leading-6 text-zinc-900 dark:text-white">Nueva Categoría</h3>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Complete la información para registrar una
                categoría.</p>
        </div>
    </div>
    ...
    <div class="px-6 py-6">
        <form wire:submit="save" class="space-y-5">
            {{-- Name --}}
            <div>
                <label for="category_name" class="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-200">
