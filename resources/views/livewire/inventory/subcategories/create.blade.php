<flux:modal name="create-subcategory" class="md:w-[500px] !p-0 overflow-hidden bg-white dark:bg-zinc-900 rounded-xl">
    <div
        ...
        <div>
            <h3 class="text-lg font-semibold leading-6 text-zinc-900 dark:text-white">Nueva Subcategoría</h3>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Registre una nueva subcategoría.</p>
        </div>
    </div>
        ...
        <form wire:submit="save" class="space-y-5">
            ...
            <div>
                ...
                <div class="mt-2 relative rounded-md shadow-sm">
                    ...
                    <input type="text" wire:model="subcategory_name" id="subcategory_name"
                        ...
                        placeholder="Ej. Sintéticos">
                </div>
                @error('subcategory_name') <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
