<flux:modal name="edit-subcategory" class="md:w-[500px] !p-0 overflow-hidden bg-white dark:bg-zinc-900 rounded-xl">
    <div
        ...
        <div>
            <h3 class="text-lg font-semibold leading-6 text-zinc-900 dark:text-white">Editar Subcategoría</h3>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Modifique los detalles de la subcategoría.</p>
        </div>
    </div>
        ...
        <form wire:submit="update" class="space-y-5">
            ...
            <div>
                ...
                <div class="mt-2 relative rounded-md shadow-sm">
                    ...
                    <input type="text" wire:model="subcategory_name" id="edit_subcategory_name"
