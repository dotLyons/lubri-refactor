<flux:modal name="create-card" class="md:w-[800px] !p-0 overflow-hidden bg-white dark:bg-zinc-900 rounded-xl">
    <div class="border-b border-zinc-200 dark:border-zinc-800 px-6 py-4 flex items-center justify-between bg-zinc-50/50 dark:bg-zinc-800/50">
        <div>
            <h3 class="text-lg font-semibold leading-6 text-zinc-900 dark:text-white">Nueva Tarjeta</h3>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Registre una nueva tarjeta y sus planes de pago en el sistema.</p>
        </div>
    </div>
        ...
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-1">
                    <label for="name" class="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-200">
                        Nombre de la Tarjeta <span class="text-red-500">*</span>
                    </label>
                    <div class="mt-2 text-zinc-900 dark:text-white">
                        <flux:input wire:model="name" id="name" placeholder="Ej. Visa Santander" />
                    </div>
                </div>

                <!-- Tipo -->
                <div class="md:col-span-1">
                    <label for="type" class="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-200">
                        Tipo de Tarjeta
                    </label>
                    <div class="mt-2 text-zinc-900 dark:text-white">
            ...
            <div class="mt-6 border-t border-zinc-200 dark:border-zinc-800 pt-6">
                ...
                <div class="space-y-4">
                    @foreach($plans as $index => $plan)
                        <div class="flex flex-col md:flex-row items-end gap-3 p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg bg-zinc-50 dark:bg-zinc-800/30">
            ...
            <div class="flex items-center justify-end gap-x-3 pt-6 mt-6 border-t border-zinc-100 dark:border-zinc-800">
                ...
                <flux:button type="submit" variant="primary" icon="check">Guardar Tarjeta</flux:button>
            </div>
        </form>
    </div>
</flux:modal>
